...
stay up to date: see
the \patternname{\href{http://peeragogy.org/patterns/heartbeat/}{Heartbeat}} pattern.}

\subsubsection*{Challenges} According to the theory proposed by Yochai Benkler,
