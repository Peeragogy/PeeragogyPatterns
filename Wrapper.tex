...
The \patternname{Wrapper} is both a role, and, sometimes, an object, like our \emph{Handbook}'s cover, or the collaboratively written chat notes from our weekly Hangouts (video conferences). 
...
We have prototyped a visual ``dashboard'' that people can use to get involved with the Peeragogy project.  Let's use the ideas in an improved interaction design for peeragogy.org.
\end{collectinmacro}
\WrapperWN
\end{framed}    
