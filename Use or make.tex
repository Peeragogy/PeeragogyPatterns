...
\paragraph{Context:}
% learning?
Peer production, as the name indicates, is about
``making stuff.'' But it also involves building on the work of others.

\paragraph{Problem:}
Usually we end up working at both levels -- for
...
to dig deeper, and recreate a system in a more bottom-up fashion.
