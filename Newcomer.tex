...
\textbf{Mutuality}: our individuality does not isolate us from one another, but draws us together. & {\icon \symbol{"002180}}%{\icon \symbol{"002117}}
\\
\end{tabular}
...
community, there is quantitative support \cite{panciera2009wikipedians}
for the 
...
\patternnameplural{Newcomer} with employment directly, so that the
