...
prepared to engage immediately in \emph{action research}
\cite{lewin1946action}.  Systematically take notes and gather data to
analyze and reflect upon later; leave artifacts for future newcomers
to use and build upon in their own research.  In practice this is a
lot to ask for someone just joining a group, but structuring
engagement so that it leads to collaborative research cycles
\emph{reflect}, \emph{plan}, \emph{act}, and \emph{observe} (and repeat)
is will improve the project and result in improved collective
understanding.
