...
When there's learning happening, it's because there is someone who is new to a topic, or to some aspect of the topic.
...
Ultimately, we render assistance to others more effectively when we do
so as peers, rather than doing it in a \emph{provisionist} mode
\cite{boud2005peer}, as experts.  Instead of thinking of newcomers as
...
As newcomers, we permit ourselves to ask naive questions.  We begin
with a relatively vague idea of our goals are.  We add concreteness by
trying \patternname{A specific project}.  We may then genuinely turn
to others for help. 
