...
\begin{center}
\begin{tabular}{l}
\textbf{$\leftarrow$\patternname{Roadmap}: In a case, the basic plan may just be to meet and share things as they come up.}\\
\textbf{$\leftarrow$\patternname{Wrapper}: It can be useful to set things up so that people can follow different rhythms.}\\
\end{tabular}
\end{center}
