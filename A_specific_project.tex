...
\textbf{Inertia}: when things are hard we may feel stuck, wring our hands, or preach to the choir. & {\icon \symbol{"00213C}}
\\
\end{tabular}
...
by working on \patternname{A specific project}.
%%%
...
sharing long-term co-habitation.  While a traditional Dormitory may
not be necessary, a shared rented or cooperatively-owned living\slash
working environment could be an asset for peeragogues working together
on \patternname{A specific project} (Figure \ref{dormitory}).
