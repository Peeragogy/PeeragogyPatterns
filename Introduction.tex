...
Writing down this pattern defines some of the key terms for \emph{Newcomers}, and illustrates the way our template works.  Participating in the project has helped us develop technical, social, and theory-building skills that we can use in our day jobs and in other projects.

\textbf{What's next:} 
With time, the \emph{Peeragogy Project} may suggest a range of new business models for education -- less lucrative perhaps, but more rewarding.  Feel free to join us or adapt our pattterns to help shape another \emph{Peeragogy Project}.