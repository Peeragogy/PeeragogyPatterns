...
focus on solutions, since people may know the ``problems'' all too well
...
\vspace{-.9in}
{\centering
\resizebox{.8\textwidth}{!}{\input{pattern-language-tikz}}

\par
}
\vspace{-.9in}
\captionsetup{font=large,width=.8\textwidth}
\caption{Peeragogy patterns are highly interconnected.  Labels at the
  borders of the figure correspond to the main sections of the
  \emph{Peeragogy Handbook}.\label{fig:connections}}
\end{figure}
\FloatBarrier
