...
Readers will have encountered peer production, at least in applications -- like Wikipedia, StackExchange, and free/libre/open source software development.  In this paper we apply design patterns to understand the human side of socio-technical developments of this sort.  In the Peeragogy project,  we aim to build upon these inspiring examples to help design the future of education.  
