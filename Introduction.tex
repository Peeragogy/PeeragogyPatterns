...
\caption{A typical university.  Inset captions
  describe the buildings: ``Ladies Hall, South Dormitory, University
  Hall, Assembly Halls \& Library, North Dormitory, Science Hall,
  President's Residence, University Farm, and Washburn Observatory.''
  This will serve as our ``key''.\label{madison-map}}
\vspace{-1.5cm}
\end{wrapfigure}
...
Section \ref{sec:Distributed_Roadmap} collects our ``What's Next'' steps, summarizes the outlook of the Peeragogy project. Section \ref{sec:Conclusion} reviews the contributions of the work as a whole.%% , positioning this work as a hands-on complement to existing sociological and historical research about peer production (surveyed in \cite{benkler2015peer}).
...
\patternname{Peeragogy} &~~find solutions together? \\
\patternname{Roadmap}&~~get everyone on the same page?\\
\patternname{Reduce, reuse, recycle}&~~avoid undue isolation?\\
\patternname{Carrying capacity}&~~avoid becoming overwhelmed?\\
\patternname{A specific project}&~~avoid becoming perplexed?\\
\patternname{Wrapper}&~~stay in touch?\\
\patternname{Heartbeat}&~~make the project ``real'' for participants?\\
\patternname{Newcomer}&~~make the project accessible to new people?\\
\patternname{Scrapbook}&~~maintain focus as time goes by?\\
\end{tabular}&
...
%% \hline 
%% %%%%%%%%%%%%%%%%%%%%
%% \vspace{-.4em}\cellcolor{Gray!30} \color{Black} \ref{sec:Roadmap}. \patternname{Roadmap}\vspace{.4em}\\
%% \hline
%% \vspace{.01em}
...
%% \hline
%% %%%%%%%%%%%%%%%%%%%%
%% \vspace{-.4em}\cellcolor{Gray!30} \color{Black} \ref{sec:Reduce, reuse, recycle}. \patternname{Reduce, reuse, recycle}\vspace{.4em}\\
%% \hline
%% \vspace{.01em}
...
%% \hline
%% %%%%%%%%%%%%%%%%%%%%
%% \vspace{-.4em}\cellcolor{Gray!30} \color{Black} \ref{sec:Carrying capacity}. \patternname{Carrying capacity}\vspace{.4em}\\
%% \hline
%% \vspace{.01em}
...
%% \hline
%% %%%%%%%%%%%%%%%%%%%%
%% \vspace{-.4em}\cellcolor{Gray!30} \color{Black} \ref{sec:A specific project}. \patternname{A specific project}\vspace{.4em}\\
%% \hline
%% \vspace{.01em}
...
%% \hline
%% %%%%%%%%%%%%%%%%%%%%
%% \vspace{-.4em}\cellcolor{Gray!30} \color{Black} \ref{sec:Wrapper}. \patternname{Wrapper}\vspace{.4em}\\
%% \hline
%% \vspace{.01em}
...
%% \hline
%% %%%%%%%%%%%%%%%%%%%%
%% \vspace{-.4em}\cellcolor{Gray!30} \color{Black} \ref{sec:Heartbeat}. \patternname{Heartbeat}\vspace{.4em}\\
%% \hline
%% \vspace{.01em}
...
%% \hline
%% %%%%%%%%%%%%%%%%%%%%
%% \vspace{-.4em}\cellcolor{Gray!30} \color{Black} \ref{sec:Newcomer}. \patternname{Newcomer}\vspace{.4em}\\
%% \hline
%% \vspace{.01em}
...
%% \hline
%% %%%%%%%%%%%%%%%%%%%%
%% \vspace{-.4em}\cellcolor{Gray!30} \color{Black} \ref{sec:Scrapbook}. \patternname{Scrapbook}\vspace{.4em}\\
%% \hline
%% \vspace{.01em}
