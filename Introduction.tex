...
\textbf{Solution:} Our \emph{Network of Learning} bridges physical and virtual worlds, moving from concrete to fantastical and back, fragmented by prism of different perspectives and unified by a desire to help make the world a better place.  We can document what we learn using a shifting catalogue of \emph{design patterns}.
