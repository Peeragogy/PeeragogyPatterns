...
%
Readers will also be familiar with \emph{peeragogy} even when the name is unfamiliar.  Peeragogy is about active learning together with others. We build emergent collaborative structures that are responsive to the changing requirements of the community of participants and the developing subject matter.
%
