...
The university provides one model for collective intelligence and collaborative learing but it is far from being the only one.
% wording issues here
Considering the successes of collaboration in Wikipedia,
