...
%
Readers will also be familiar with \emph{peeragogy}, even if the name is unfamiliar.  Peeragogy describes active learning together with others.  Participants in a peeragogical endeavor collaboratively build emergent  structures that are responsive to their changing requirements.
%
