...
%
Readers will also be familiar with \emph{peeragogy} even when the name is unfamiliar.  Peeragogy is a word for active learning together with others.  Participants in a peeragogical endeavor collaboratively build emergent  structures that are responsive to their changing requirements the developing subject matter.
%
