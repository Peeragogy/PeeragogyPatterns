...
\subsubsection*{\hyperref[sec:Peeragogy_Project]{Peeragogy Project}} Feel free to join us and suggest new patterns and projects, or adapt our patterns to help shape another \patternname{Peeragogy Project}.
...
(compare the \patternname{Newcomer} pattern).

\subsubsection*{\hyperref[sec:A_specific_project]{A specific project}}
 Each project connected with the Peeragogy project should be described with one or more patterns, each with specific, tangible ``what's next'' steps.  The \patternname{Pattern Audit Routine} can help make these ``what's next'' steps concrete.
