...
\textbf{There is a tension between the generality/inclusiveness of an ``open'' work and the specificity/concretion required in order to develop something really useful.  We have to learn to trust each other in order for this to happen.}
