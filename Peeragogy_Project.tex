...
\textbf{There is a tension between the generality/inclusiveness of an ``open'' work and the specificity/concretion required in order to develop something useful to society.}
