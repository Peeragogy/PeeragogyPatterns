...
\begin{center}
\begin{tabular}{l}
\textbf{$\leftarrow$\patternname{Roadmap}: A group of people is figuring out how to get from ``here'' to ``there'' together.}\\
\textbf{$\leftarrow$\patternname{Carrying capacity}: Each contributor, and the group, has bounded time and other resources.}
\end{tabular}
\end{center}
