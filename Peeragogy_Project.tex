...
\vspace{-1.5cm}
\begin{center}
\includegraphics[width=.34\textwidth,trim=0 0 0 100, clip=true]{Space_Surveillance_Telescope}
\end{center}
\vspace{-.5cm}
...
reach \emph{ad astra, per aspera}.\footnote{Latin motto, ``With difficulty, to the stars.''}
