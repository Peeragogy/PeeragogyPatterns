...
\subsubsection*{Solution} \emph{Peeragogy} is our word for the process whereby different people involved with different projects can describe material problems and share solutions and work in progress.  There are different ways to go about this -- bug reports, mailing lists, writers workshops -- but we have found that the process is particularly well-matched to Christopher Alexander's idea of \emph{design patterns}, in which a pattern can be described using a simple template, and refined until it becomes perfectly clear.  \patternname{Peeragogy} is an up-to-date version of Alexander's \patternname{Network of Learning} \cite[p. 99]{alexander1977pattern}.  We ``decentralize the process of learning and enrich it through contact with many places and people'' -- potentially all over the world.  We combine a free/open approach with reflection on what works in the project.
