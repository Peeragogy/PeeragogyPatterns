...
At the same time, they invoke a form of friendly competition, in which \emph{the best craftmanship wins} \cite[p.~89]{raymond2001cathedral}.  ``Peer-led'' doesn't mean there are no leaders: it means that leaders
are peers.
%%% FORCES
