...
We repeat: the essence of peeragogy is to combine an accessible approach with reflective practice. When we're able to share our learning process fluidly with others, this expands the range of available perspectives and can produce new insights into how things work.  Our motto for the \emph{Peeragogy Handbook} is ``This is a how-to handbook.''  However, because we're always learning new things, it is always an imperfect guide.  Furthermore, if we're honest, the best way to learn about peeragogy is not to read the \emph{Handbook}, but to work on putting peeragogy into action.
...
Peeragogy helps people in different projects describe and solve real problems.  It can guide individual action in ways that we wouldn't have seen on our own, and may lead to collective action we would not have imagined possible.
