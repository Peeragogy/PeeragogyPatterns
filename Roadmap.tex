...
\subsubsection*{Solution}  Building a guide to the goals, activities, experiments and working methods can help \patternnameplural{Newcomer} and old-timers alike understand their relationship with the project.
%% This guide may be a research question or an outline, an organizational mission statement, or a business plan.
...
%% Everyone with an interest in the project should have the right to update it, although in practice not everyone will choose to do so.
...
\patternname{Heartbeat}, supplemented by a list of upcoming deadlines.
...
roadmap is an antidote to \patternnameext{Tunnel Vision}
...
%
 ...
 on \patternname{A specific project}.
...
organization.  This is what the \patternname{Roadmap} provides.
