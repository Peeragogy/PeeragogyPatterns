...
\vspace{-2.05cm}
\begin{center}
\includegraphics[width=.5\textwidth,trim=140 30 30 30, clip=true]{alabama-big}
\end{center}
\vspace{-.5cm}
\caption{President's Home, University of Alabama. Public
  domain.\label{presidents-home}}
\vspace{-1.9cm}
\end{wrapfigure}
