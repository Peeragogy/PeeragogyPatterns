...
\vspace{-.2cm}
\begin{center}
\includegraphics[width=.45\textwidth,trim=0 325 0 500, clip=true]{ChristsPieces}
\end{center}
\vspace{-.5cm}
...
over time, future peeragogues' will be drawn to consider new problems and patterns.
