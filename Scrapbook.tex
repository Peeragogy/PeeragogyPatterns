...
We have maintained and revised our pattern catalog, and we are achieving
some of the ``What's Next'' steps associated with some of the patterns.
...
The Wikimedia Foundation's previous ``five year plan'' somewhat resembles a \patternname{Scrapbook} \cite{wikimedia2011plan}.  
