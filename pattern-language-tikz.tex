...
\node (assess) at (5, 9.5) {{\Large { Assess}}};
\node (organize) at (5, 0) {{\Large { Organize}}};
\node (convene)[text width=2cm,align=center,rotate=270] at (10, 5) {{\Large { Convene}}};
\node (cooperate)[text width=15cm,align=center,rotate=90] at (0, 5) {{\Large { ~Cooperate}}};
...
\draw[-{Latex[width=2mm]},draw=gray] (carryingcapacity.340) -- (newcomer);
\draw[-{Latex[width=2mm]},draw=gray] (carryingcapacity.333) -- (roadmap);
