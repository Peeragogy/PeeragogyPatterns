...
In closing, we evaluate the contributions of the current paper under
headings borrowed from \cite{benkler2015peer}.
...
\subsubsection*{Motivation}  As Philipp Schmidt indicates, learning can
generally be found at the core of peer production communities
