...
%
The university metaphor guided our inquiry but should not constrain
it: there are aspects of a distributed (and emergent) approach that
make ``the super-imposition of being a `University' not only
unnecessary, but somehow quaintly dated and obsolete,'' in the words
peeragogue Doug Breitbart.
%
