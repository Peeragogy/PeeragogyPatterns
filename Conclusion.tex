...
varied levels of scale, degrees of formality, inside or outside of
...
Chartes of programming -- but it may also end up looking more like a
...
patterns as part of a research intervention.  Compelling examples
notwithstanding, peer production is not guaranteed to out-compete
proprietary solutions \cite{benkler2015peer,free-software-better}.
Even if we are ultimately able to recruit sufficient help and put in
an enormous amount of time, success will depend on the way the
problem, or problems, are framed.  This where the strategy for use of
design patterns demonstrated in the current paper holds the greatest
promise.
