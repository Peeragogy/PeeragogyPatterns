...
\draw[draw=black,dashed,name path=line 3] (aspecificproject.230) to[out=250,in=40] (scrapbook)node[text opacity=0]        {3};
...
\draw[draw=black,dashed,name path=line 6] (carryingcapacity.343) -- ([xshift=2mm]roadmap.160)node[text opacity=0]         {6};
\draw[draw=black,dashed,name path=line 7] (carryingcapacity) -- (peeragogyproject)node[text opacity=0]                    {7};
\draw[draw=black,dashed,name path=line 8] ([xshift=1mm]carryingcapacity.south) -- (scrapbook.140)node[text opacity=0]     {8};
\draw[draw=black,dashed,name path=line 9] (heartbeat) -- (aspecificproject.210)node[text opacity=0]                       {9};
...
\draw[draw=black,dashed,name path=line 12] (heartbeat) -- (reduce.215)node[text opacity=0]                                {12};
...
\draw[draw=black,dashed,name path=line 17] (roadmap) -- (peeragogyproject.205)node[text opacity=0]                        {17};
\draw[draw=black,dashed,name path=line 18] (roadmap.200) -- (heartbeat)node[text opacity=0]                               {18};
\draw[draw=black,dashed,name path=line 19] (scrapbook) -- (wrapper)node[text opacity=0]                                   {19};
\draw[draw=black,dashed,name path=line 20] (scrapbook.110) to[out=123,in=250] (reduce.245) node[text opacity=0]            {20};
\draw[draw=black,dashed,name path=line 21] (scrapbook.70) to[out=43,in=305] (roadmap.315) node[text opacity=0]             {21};
\draw[draw=black,dashed,name path=line 22] (reduce) -- (carryingcapacity)node[text opacity=0]                             {22};
\draw[draw=black,dashed,name path=line 23] (reduce) -- (roadmap)node[text opacity=0]                                      {23};
